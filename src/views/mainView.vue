<template>
  <!-- TODO: Вычитать ниже по документобороту что делается, убрать лишнее с фронта -->
    <!-- Хранить в сессии еще эпоху, раунд, мб факт фазы состояния(если раунд 4), какого игрока сейчас ход -->
     <!-- В игроках хранить расположение игроков на поле(присвоить при начале игры ref_placement рандомный), очерёдность игроков в этой эпохе(ordering), факт завершённого хода в этом ходу, текущее действие, статус действия(докоборот) и кол-во оставшихся действий -->
     <!-- Для каждого действия написать докоборот с "Действие выбрано" до "Действие завершено" -->
      <!-- Так же в игроках нужно хранить счётчики ресурсов и жетонов -->
       <!-- Отдельными таблицами нужно хранить юнитов(лидеров в т.ч, но они не нарисованы еще), здания, достижения -->
        <!-- Справочники: регионы/тайлы, достижения -->
  <div class="main">
